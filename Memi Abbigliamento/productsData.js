...
(function (root) {
  ...
  var PRODUCTS = [
    ...
    { id: 'pantalone-culotte-zen', name: 'Pantalone Culotte Zen', categoria: 'pantaloni', taglie: ['38','40','42','44','46','48'],             colore: 'salvia',   colorLabel: 'Verde muschio',      price: 88,  icon: 'dress', altColor: 'ph-cream',    popularity: 17, collections: ['shop-all','pantaloni'] },
